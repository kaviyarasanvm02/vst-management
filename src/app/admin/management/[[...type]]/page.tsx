...
export default async function ConsolidatedManagementPage({
    params,
}: {
    ...
    // If no segment, we could default to attendance-requests or show a 404
    if (pathSegments.length === 0) {
        redirect('/admin/management/attendance-requests');
    }
